...
class NS_NO_VTABLE NS_SCRIPTABLE ICHMUnitInfo : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetNativeChmUnitInfo(struct chmUnitInfo * *_retval) = 0;
...
#define NS_DECL_ICHMUNITINFO \
  ...
  NS_IMETHOD GetNativeChmUnitInfo(struct chmUnitInfo * *_retval); 
...
#define NS_FORWARD_ICHMUNITINFO(_to) \
  ...
  NS_IMETHOD GetNativeChmUnitInfo(struct chmUnitInfo * *_retval) { return _to GetNativeChmUnitInfo(_retval); } 
...
#define NS_FORWARD_SAFE_ICHMUNITINFO(_to) \
  ...
  NS_IMETHOD GetNativeChmUnitInfo(struct chmUnitInfo * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNativeChmUnitInfo(_retval); } 
...
/* [noscript] npChmUnitInfo getNativeChmUnitInfo (); */
NS_IMETHODIMP _MYCLASS_::GetNativeChmUnitInfo(struct chmUnitInfo * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
