...
class NS_NO_VTABLE NS_SCRIPTABLE ICHMFile : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD LoadCHM(nsIFile *chmfile, PRInt32 *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD ResolveObject(const nsACString & path, ICHMUnitInfo **_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_ICHMFILE \
  NS_SCRIPTABLE NS_IMETHOD LoadCHM(nsIFile *chmfile, PRInt32 *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_ICHMFILE(_to) \
  NS_SCRIPTABLE NS_IMETHOD LoadCHM(nsIFile *chmfile, PRInt32 *_retval NS_OUTPARAM) { return _to LoadCHM(chmfile, _retval); } \
...
#define NS_FORWARD_SAFE_ICHMFILE(_to) \
  NS_SCRIPTABLE NS_IMETHOD LoadCHM(nsIFile *chmfile, PRInt32 *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->LoadCHM(chmfile, _retval); } \
...
/* long LoadCHM (in nsIFile chmfile); */
NS_IMETHODIMP _MYCLASS_::LoadCHM(nsIFile *chmfile, PRInt32 *_retval NS_OUTPARAM)
{
...
/* ICHMUnitInfo resolveObject (in ACString path); */
NS_IMETHODIMP _MYCLASS_::ResolveObject(const nsACString & path, ICHMUnitInfo **_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* ACString retrieveObject (in ICHMUnitInfo ui, in long start, in long length); */
NS_IMETHODIMP _MYCLASS_::RetrieveObject(ICHMUnitInfo *ui, PRInt32 start, PRInt32 length, nsACString & _retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* nsIInputStream getInputStream (in ICHMUnitInfo ui); */
NS_IMETHODIMP _MYCLASS_::GetInputStream(ICHMUnitInfo *ui, nsIInputStream **_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
